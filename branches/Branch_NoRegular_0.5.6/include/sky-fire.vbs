'2010-12-30 http://www.shanhaijing.net/163
...
Function FixAllComicUrl(url_str)
    ...
    'http://pic3.sky-fire.com/Utility/331/080.js
    'http://pic3.sky-fire.com/AllComic/331/081/    
On Error Resume Next
    Dim temp_str,temp_url
    url_str = Mid(url_str, InStr(LCase(url_str), ".sky-fire.com/allcomic/")+Len(".sky-fire.com/allcomic/"))

...
If InStr(LCase(URL),"b http://")=1 or InStr(LCase(URL),"b%20http://")=1 or InStr(LCase(URL),"http://b%20http//")=1 Then
  ...
  URL="http:" & Mid(URL,InStr(LCase(URL),"//"))
...
ElseIf InStr(LCase(URL),"getchu.com")>8 and InStr(LCase(URL),"getchu.com")<15 Then
	If InStr(LCase(URL),"http://www.getchu.com")=1 Then
		OX163_Web_Browser_ctrl=replace(LCase(URL),"http://www.getchu.com","http://210.155.150.145") & vbCrLf & vbCrLf & "" & vbCrLf & vbCrLf & "" & vbCrLf & vbCrLf & "" & vbCrLf & vbCrLf & ""
	ElseIf InStr(LCase(URL),"http://getchu.com")=1 Then
		OX163_Web_Browser_ctrl=replace(LCase(URL),"http://getchu.com","http://210.155.150.145") & vbCrLf & vbCrLf & "" & vbCrLf & vbCrLf & "" & vbCrLf & vbCrLf & "" & vbCrLf & vbCrLf & ""
	End If

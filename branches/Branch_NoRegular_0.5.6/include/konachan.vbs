'2010-12-24 163.shanhaijing.net
Dim page_counter
...
'http://konachan.com/pool/show/596?page=3
'http://konachan.com/wiki/show?title=park_sung-woo
'http://konachan.com/wiki/show?page=3&title=park_sung-woo
...
If InStr(LCase(url_str), "http://konachan.com/pool/show/") =1 Then
    ...
    url_instr=url_str
ElseIf InStr(LCase(url_str), "http://konachan.com/wiki/show?") =1 Then
    pool="wiki"

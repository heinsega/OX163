...
ElseIf instr(html_str,"<div id=""thums"">")>0 Then
	html_str=mid(html_str,instr(html_str,"<div id=""thums"">"))
	If instr(html_str,"<li><a href=""")>0 Then
		html_str=mid(html_str,instr(html_str,"<li><a href=""")+13)
		html_str=mid(html_str,1,instr(html_str,"""")-1)
		return_download_list = "1|inet|10,13|" & main_url & html_str
	End If
end If
End Function